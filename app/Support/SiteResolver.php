...
class SiteResolver
{
    ...
    private static function fromSiteModel(Site $site, string $resolvedHost = ''): SiteContext
    {
        ...
        return new SiteContext(
            ...
            companyAddress: (string) ($site->company_address ?: config($fallbackPrefix.'company_address') ?: ''),
            phoneNumber: (string) ($site->phone_number ?: config($fallbackPrefix.'phone_number') ?: ''),
            ukPhoneNumber: (string) ($site->uk_phone_number ?: config($fallbackPrefix.'uk_phone_number') ?: ''),
            ukAddress: (string) ($site->uk_address ?: config($fallbackPrefix.'uk_address') ?: ''),
            pkPhoneNumber: (string) ($site->pk_phone_number ?: config($fallbackPrefix.'pk_phone_number') ?: ''),
            pkAddress: (string) ($site->pk_address ?: config($fallbackPrefix.'pk_address') ?: ''),
    ...
    private static function siteContextFromArray(array $site): SiteContext
    {
        ...
        return new SiteContext(
            ...
            ukPhoneNumber: (string) ($site['uk_phone_number'] ?? ''),
            ukAddress: (string) ($site['uk_address'] ?? ''),
            pkPhoneNumber: (string) ($site['pk_phone_number'] ?? ''),
            pkAddress: (string) ($site['pk_address'] ?? ''),
