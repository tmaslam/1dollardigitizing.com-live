...
@include('shared.file-preview-styles')
        ...
        * { box-sizing: border-box; }
        ...
        .brand:hover { background: rgba(255,255,255,0.15); }
        .brand img { height: 56px; width: auto; display: block; margin: 0 auto; }
        .brand span { display: block; margin-top: 8px; font-size: 1.05rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; color: rgba(255,255,255,0.82); }
        .section-title {
...
<div class="shell">
    <aside class="sidebar">
        ...
        <a href="{{ url('/team/welcome.php') }}" class="brand {{ request()->is('team/welcome.php') ? 'active' : '' }}">
            <img src="{{ url('/images/logo.png') }}" alt="1Dollar Digitizing">
            <span>{{ $teamUser->is_supervisor ? 'Supervisor' : ($teamUser->isFreelance() ? 'Freelance Team' : 'In-house Team') }}</span>
        </a>
        ...
        @if ($teamUser->is_supervisor ?? false)
            ...
            <div class="nav-card">
                ...
                <a href="{{ url('/team/supervisor/assignments') }}" class="{{ request()->is('team/supervisor/assignments') ? 'active' : '' }}">
                    <span>Assignment Monitor</span>
                    <span class="count">{{ $navCounts['assigned_jobs'] ?? 0 }}</span>
                </a>
        ...
        <div class="nav-card">
            <a href="{{ url('/team/my-jobs') }}" class="{{ request()->is('team/my-jobs') ? 'active' : '' }}"><span>My Job History</span></a>
