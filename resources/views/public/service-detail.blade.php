...
@php
    ...
    if (! empty($service['schema_price'])) {
        $serviceSchema['offers'] = [
            '@type' => 'Offer',
            'priceCurrency' => 'USD',
            'price' => $service['schema_price'],
            'description' => $service['schema_price_spec'] ?? '',
        ];
    }
    ...
    $breadcrumbSchema = [
        ...
        'itemListElement' => [
            ...
            ['@type' => 'ListItem', 'position' => 2, 'name' => 'Services', 'item' => url('/our-services.php')],
    ...
    <section class="section">
        <div class="container">
            <div class="template-cta-card">
                <span class="theme-badge">Ready to Start?</span>
                <h2>Book a Meeting to Discuss Your Project</h2>
                <p>Schedule a quick call with our team. We'll review your artwork, confirm the turnaround, and walk you through pricing — no commitment required.</p>
                <div class="theme-header-actions">
                    <a class="button primary" href="{{ url('/book-a-meeting.php') }}">Book a Meeting</a>
