...
@section('content')
    ...
    <section class="card">
        <div class="card-body">
            ...
            <p class="muted" style="margin-top:14px;font-size:.85rem;">A <strong>10-digit</strong> verification code will be emailed to your registered address. Enter it on the next screen to confirm the change.</p>
        </div>
    </section>
@endsection
